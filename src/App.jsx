...
const ROUNDS = [
  {
    ...
    format:"Written",
    questions:[
      {q:"Explain the concept of Perceptual Mapping in marketing.", a:"It is a visual tool used to understand how consumers perceive brands compared to competitors. It plots brands based on attributes like price and quality to identify positioning opportunities."},
      {q:"What is Customer Lifetime Value (CLV) and why is it important?", a:"CLV is the total value a customer generates over the entire relationship with a business. It helps companies decide how much to invest in acquiring and retaining customers."},
      {q:"Define Relationship Marketing.", a:"It focuses on building long-term relationships with customers instead of one-time transactions. This increases loyalty, retention, and long-term profitability."},
      {q:"What is Customer Value in marketing?", a:"Customer value is the difference between perceived benefits and cost. Higher value leads to greater satisfaction and repeat purchases."},
      {q:"Explain Market Orientation.", a:"It is a business approach where all departments focus on identifying and satisfying customer needs better than competitors."},
      {q:"What is Product Differentiation?", a:"It is the strategy of making a product appear unique in the minds of consumers. This helps brands stand out in competitive markets."},
      {q:"What is Switching Cost?", a:"It refers to the financial or psychological cost a customer faces when switching brands. Higher switching costs reduce customer movement."},
      {q:"Explain Customer Equity.", a:"Customer equity is the total value of all customers over time. It shows how valuable a firm’s customer base is."},
      {q:"What is Demand Elasticity?", a:"It measures how sensitive demand is to price changes. High sensitivity means elastic demand."},
      {q:"Define Market Potential.", a:"It is the maximum possible demand for a product in a market under ideal conditions."},
      {q:"What is Consumer Involvement?", a:"It refers to how important a product is to a consumer, affecting decision-making effort."},
      {q:"Explain Value Chain.", a:"It includes all activities that add value to a product from production to delivery."},
      {q:"What is Customer Engagement?", a:"It represents emotional and behavioral interaction between customers and brands."},
      {q:"What is Competitive Advantage?", a:"It is a firm’s ability to outperform competitors through cost or differentiation."},
      {q:"Explain Market Positioning.", a:"It is creating a distinct image of a brand in the customer’s mind relative to competitors."}
    ]
  },

  {
    ...
    format:"Buzzer",
    questions:[
      {q:"When demand changes significantly due to price change, it is called ______ demand.", a:"Elastic. Demand is elastic when small price changes cause large changes in quantity demanded."},
      {q:"Charging high price initially and then reducing is ______ pricing.", a:"Skimming. It helps recover costs early and targets premium customers first."},
      {q:"Repeated purchase of same brand is called ______.", a:"Brand Loyalty. It shows trust and reduces need for heavy promotion."},
      {q:"Selling directly without intermediaries is ______ channel.", a:"Direct. It allows companies better control and higher margins."},
      {q:"Making a product appear unique is called ______.", a:"Differentiation. It helps brands stand out even if actual difference is small."},
      {q:"Total possible demand in a market is called ______.", a:"Market Potential. It shows maximum sales opportunity available."},
      {q:"Focusing on existing customers is called ______ strategy.", a:"Retention. It is cheaper and increases long-term profitability."},
      {q:"Data collected first-hand is called ______ research.", a:"Primary. It is original data collected through surveys or interviews."},
      {q:"Selling through many outlets is called ______ distribution.", a:"Intensive. It ensures maximum availability and reach."},
      {q:"Charging different prices to different customers is ______ pricing.", a:"Price Discrimination. It helps maximize revenue based on willingness to pay."},
      {q:"When value exceeds price, it creates ______.", a:"Customer Value. Customers feel satisfied when benefits exceed cost."},
      {q:"Selling related products together is called ______.", a:"Cross Selling. It increases total purchase value by offering complementary products."}
    ]
  },

  {
    ...
    format:"Written",
    questions:[
      {q:"ChatGPT ads showing real-life uses like study and travel planning.", a:"Human-Centric Marketing. This approach makes technology relatable by focusing on real-life benefits rather than complex features."},
      {q:"Coca-Cola AI campaign allowing users to create content.", a:"AI Personalization. It uses AI to create customized experiences, increasing engagement and interaction."},
      {q:"Nike using customer data for personalized ads.", a:"Data-Driven Marketing. Decisions are based on customer data, improving targeting accuracy."},
      {q:"Duolingo shifting to creators instead of ads.", a:"Influencer Marketing. It builds trust through creators and community engagement :contentReference[oaicite:0]{index=0}"},
      {q:"Burger King accepting its past mistakes in ads.", a:"Brand Repositioning. It changes brand perception to regain customer trust :contentReference[oaicite:1]{index=1}"},
      {q:"Svedka using fully AI-generated advertisement.", a:"AI Automation Marketing. Shows shift toward automated ad creation :contentReference[oaicite:2]{index=2}"},
      {q:"Amul creating ads on current events.", a:"Content Marketing. Regular content keeps brand relevant and engaging."},
      {q:"Fevicol ads focusing on strong bonding stories.", a:"Emotional Advertising. Emotional connection makes ads memorable."},
      {q:"Apple maintaining high price despite competition.", a:"Prestige Pricing. High price creates premium perception."},
      {q:"Colgate distributing free samples.", a:"Sales Promotion. Short-term incentives encourage trial and sales."}
    ]
  },

  {
    ...
    format:"Buzzer",
    questions:[
      {q:"Explain Market Penetration.", a:"It means increasing sales of existing products in existing markets using pricing or promotion strategies."},
      {q:"What is Market Development?", a:"Entering new markets with existing products to expand reach."},
      {q:"What is Diversification?", a:"Launching new products in new markets to reduce business risk."},
      {q:"What is Product Innovation?", a:"Developing new or improved products to meet changing needs."},
      {q:"What is Customer Retention?", a:"Keeping existing customers loyal through satisfaction and engagement."},
      {q:"Define Customer Acquisition Cost.", a:"Total cost spent to acquire a new customer through marketing and sales."},
      {q:"What is Break-even Point?", a:"The level where total revenue equals total cost, meaning no profit or loss."},
      {q:"What is Channel Conflict?", a:"Disagreement between intermediaries affecting distribution efficiency."},
      {q:"What is Direct Marketing?", a:"Selling directly to customers without intermediaries."},
      {q:"What is E-Marketing?", a:"Marketing through digital platforms like internet and social media."},
      {q:"What is Demand Forecasting?", a:"Predicting future demand to plan production and sales."},
      {q:"What is Test Marketing?", a:"Launching a product in a limited market to check performance."},
      {q:"What is Market Share?", a:"Percentage of total sales controlled by a company."},
      {q:"Define Consumer Behavior.", a:"Study of how consumers make buying decisions."},
      {q:"What is Value Proposition?", a:"The value or benefit promised to customers."},
      {q:"What is Cross Selling?", a:"Selling related products along with main product."},
      {q:"What is Up Selling?", a:"Encouraging customers to buy higher-value products."},
      {q:"What is Demographic Segmentation?", a:"Dividing market based on age, income, gender, etc."},
      {q:"What is Push Strategy?", a:"Promoting products through distribution channels."},
      {q:"What is Pull Strategy?", a:"Creating demand so customers actively seek the product."}
    ]
  }
];
// ── Confetti ────────────────────────────────────────────────────────────────
