...
const ROUNDS = [
  {
    ...
    format:"Written",
    questions:[
      {q:"Perceptual Mapping", a:"Graphical representation of how consumers perceive brands relative to competitors"},
      {q:"Customer Lifetime Value (CLV)", a:"Total value a customer generates over entire relationship"},
      {q:"Relationship Marketing", a:"Strategy focused on long-term customer engagement"},
      {q:"Customer Value", a:"Difference between perceived benefits and cost"},
      {q:"Market Orientation", a:"Organization-wide focus on customer needs"},
      {q:"Product Differentiation", a:"Creating perceived uniqueness"},
      {q:"Switching Cost", a:"Cost of changing brands"},
      {q:"Customer Equity", a:"Total value of all customers"},
      {q:"Demand Elasticity", a:"Sensitivity of demand to price"},
      {q:"Market Potential", a:"Maximum possible demand"},
      {q:"Consumer Involvement", a:"Importance of purchase decision"},
      {q:"Value Chain", a:"Activities adding value"},
      {q:"Customer Engagement", a:"Emotional and behavioral involvement"},
      {q:"Competitive Advantage", a:"Ability to outperform competitors"},
      {q:"Market Positioning", a:"Place in customer’s mind"}
    ]
  },

  {
    ...
    format:"Buzzer",
    questions:[
      {q:"When price increases and demand falls sharply, demand is ______", a:"Elastic"},
      {q:"High price first then reducing is ______ pricing", a:"Skimming"},
      {q:"Repeated purchase of same brand is ______", a:"Brand Loyalty"},
      {q:"Selling without intermediaries is ______ channel", a:"Direct"},
      {q:"Making product look unique is ______", a:"Differentiation"},
      {q:"Total possible buyers is ______", a:"Market Potential"},
      {q:"Focusing on old customers is ______ strategy", a:"Retention"},
      {q:"Data collected first time is ______ research", a:"Primary"},
      {q:"Available everywhere is ______ distribution", a:"Intensive"},
      {q:"Different prices to different people is ______ pricing", a:"Price Discrimination"},
      {q:"When value > price, it creates ______", a:"Customer Value"},
      {q:"Selling related products together is ______", a:"Cross Selling"}
    ]
  },

  {
    ...
    format:"Written",
    questions:[
      {q:"ChatGPT ads showing real-life uses", a:"Human-Centric Marketing"},
      {q:"Coca-Cola 'Create Real Magic' AI campaign", a:"AI Personalization"},
      {q:"Nike using customer data for ads", a:"Data-Driven Marketing"},
      {q:"Duolingo using creators instead of ads", a:"Influencer Marketing"},
      {q:"Burger King 'Reclaim the Flame' honesty campaign", a:"Brand Repositioning"},
      {q:"McDonald's viral CEO video moment", a:"Viral Marketing"},
      {q:"Amul topical ads", a:"Content Marketing"},
      {q:"Fevicol strong bonding ads", a:"Emotional Advertising"},
      {q:"Apple premium pricing strategy", a:"Prestige Pricing"},
      {q:"Colgate free samples campaign", a:"Sales Promotion"}
    ]
  },

  {
    ...
    format:"Buzzer",
    questions:[
      {q:"Market Penetration", a:"Increase share in existing market"},
      {q:"Market Development", a:"Enter new markets"},
      {q:"Diversification", a:"New product + new market"},
      {q:"Product Innovation", a:"New or improved product"},
      {q:"Customer Retention", a:"Keeping existing customers"},
      {q:"Customer Acquisition Cost", a:"Cost to acquire customer"},
      {q:"Break-even Point", a:"No profit no loss"},
      {q:"Channel Conflict", a:"Conflict between intermediaries"},
      {q:"Direct Marketing", a:"Selling directly"},
      {q:"E-Marketing", a:"Online marketing"},
      {q:"Demand Forecasting", a:"Predicting demand"},
      {q:"Test Marketing", a:"Testing in small market"},
      {q:"Market Share", a:"Percentage of total sales"},
      {q:"Consumer Behavior", a:"Study of buying behavior"},
      {q:"Value Proposition", a:"Promise of value"},
      {q:"Cross Selling", a:"Selling related products"},
      {q:"Up Selling", a:"Selling higher value product"},
      {q:"Demographic Segmentation", a:"Segmentation based on population factors"},
      {q:"Push Strategy", a:"Push product through channels"},
      {q:"Pull Strategy", a:"Create demand from consumers"}
    ]
  }
];
// ── Confetti ────────────────────────────────────────────────────────────────
